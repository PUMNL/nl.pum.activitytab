  ...
  <div class="crm-accordion-wrapper crm-search_filters-accordion">
    ...
    <div class="crm-accordion-body">
      <div class="no-border form-layout-compressed" id="searchOptions">
          ...
          <div class="crm-contact-form-block-activity_type_include_source_contact crm-inline-edit-field">
            <input id="include_source_contact" type="checkbox" value="1">{ts}Include activities added by{/ts}
          </div>
      </div>
...
<script type="text/javascript">
  ...
  cj(function ( ) {
    ...
    cj('#include_source_contact').change(function() {
      buildContactActivities{/literal}{$context}{literal}( true );
    });
  });
...
function buildContactActivities{/literal}{$context}{literal}( filterSearch ) {
  ...
  var context = {/literal}"{$context}"{literal};
  var columns = '';
  var sourceUrl = {/literal}'{crmURL p="civicrm/activitytab/ajax/contactactivity" h=0 q="snippet=4&context=$context&cid=$contactId"}'{literal};
  ...
  {/literal}{$context}{literal}oTable = cj('#contact-activity-selector-' + context ).dataTable({
    ...
    "fnServerData": function ( sSource, aoData, fnCallback ) {
      ...
      {name:'include_source_contact',   value: (cj('#include_source_contact').is(':checked') ? '1' : '0')}
      );
